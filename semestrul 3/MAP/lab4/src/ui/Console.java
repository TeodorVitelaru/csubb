...
public class Console {
    ...
    {
        serviceUtilizator.all_utilizators().forEach(utilizator -> {
            System.out.println(utilizator + ", prieteniID=" + serviceUtilizator.prieteni(utilizator.getId()).toString() + "}");
        });
    ...
    {
        serviceUtilizator.all_prietenii().forEach(prietenie -> {
    ...
    public void adaugare_user_ui()
    {
        try{
            ...
            this.serviceUtilizator.addUtilizator(first, last);
